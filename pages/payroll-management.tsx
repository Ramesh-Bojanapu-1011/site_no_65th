...
const faqs = [
  {
    ...
    answer:
      "Payroll management is the process of administering employee salaries, wages, bonuses, deductions, and tax withholdings.",
  },
  {
    question: "Why is payroll management important?",
    answer:
      "Accurate payroll ensures employees are paid correctly and on time, and helps your business stay compliant with regulations.",
  },
  {
    question: "Who needs payroll management services?",
    answer:
      "Businesses of all sizes benefit from professional payroll management to reduce errors and save time.",
  },
  {
    question: "How often should payroll be processed?",
    answer:
      "Payroll is typically processed weekly, bi-weekly, or monthly, depending on your business needs.",
  },
  {
    question: "Do you offer customized payroll solutions?",
    answer:
      "Yes, we tailor our payroll management services to fit your unique business requirements.",
  },
];
...
const benefits = [
  {
    title: "Accuracy",
    desc: "Ensure employees are paid correctly and on time.",
    icon: (
      <svg
...
const processSteps = [
  {
    title: "Setup",
    desc: "We help you establish a reliable payroll system.",
    icon: (
      <svg
  ...
  {
    title: "Processing",
    desc: "We process payroll accurately and on schedule.",
    icon: (
      <svg
  ...
  {
    title: "Reporting",
    desc: "We provide clear payroll reports and records.",
    icon: (
      <svg
        className="w-8 h-8 text-[#21c2ad]"
        fill="none"
  ...
  {
    title: "Compliance",
    desc: "We ensure your payroll meets all legal requirements.",
    icon: (
      <svg
        className="w-8 h-8 text-[#155dfc]"
        fill="none"
...
const PayrollManagementPage = () => {
  return (
    <>
      <Head>
        <title>Payroll Management | FinAccount</title>
        <meta
          name="description"
          content="Professional payroll management services for businesses of all sizes."
        />
      </Head>
        ...
        <section className="flex flex-col md:flex-row items-center justify-between px-8 py-24 gap-12 bg-gradient-to-tr from-blue-100 via-white to-blue-200 dark:from-blue-950 dark:via-gray-900 dark:to-blue-900 text-blue-900 dark:text-blue-100 min-h-screen">
          <div className="flex-1 flex flex-col justify-center items-start">
            ...
            <p className="text-lg md:text-2xl mb-8 max-w-xl">
              Ensure accuracy, compliance, and efficiency with our expert
              payroll management services tailored for your business.
            </p>
          </div>
        ...
        <section className="py-20 px-8 bg-gradient-to-tr from-blue-100 via-white to-blue-200 dark:from-blue-950 dark:via-gray-900 dark:to-blue-900">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-lg text-gray-700 dark:text-blue-200 mb-12 text-center max-w-3xl mx-auto">
              Our efficient process ensures your payroll is accurate, compliant,
              and hassle-free. We guide you from setup to compliance, so you can
              focus on your business and your team.
            </p>
              ...
              {processSteps.map((step, idx) => (
                ...
                >
                  ...
                  <div className="text-sm text-gray-500 dark:text-blue-300 mt-2">
                    {idx === 0 &&
                      "We help you establish a reliable payroll system."}
                    {idx === 1 &&
                      "We process payroll accurately and on schedule."}
                    {idx === 2 &&
                      "We provide clear payroll reports and records."}
                    {idx === 3 &&
                      "We ensure your payroll meets all legal requirements."}
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="flex flex-col items-center mb-12">
              ...
              <p className="text-gray-700 dark:text-gray-300 text-center max-w-2xl mb-8">
                Find answers to common questions about payroll management,
        ...
        <section className="py-20 px-8 relative overflow-hidden">
          <div className="max-w-3xl py-20 px-8 mx-auto flex flex-col items-center text-center relative z-10 rounded-2xl shadow-xl bg-white/80 dark:bg-blue-950/80 backdrop-blur-lg border-2 border-transparent before:absolute before:inset-0 before:rounded-2xl before:pointer-events-none before:bg-gradient-to-r before:from-[#21c2ad] before:via-[#155dfc] before:to-[#21c2ad] before:opacity-30">
            ...
            <p className="text-lg md:text-xl mb-8 max-w-xl text-blue-900 dark:text-blue-100">
              Let our experts help you manage payroll with accuracy and
              compliance. Contact us today and focus on growing your business
              and your team.
            </p>
            <Link
              href="/contact-us"
