...
const faqs = [
  {
    questionKey: "PayrollManagement.FAQs.q1",
    answerKey: "PayrollManagement.FAQs.a1",
  },
  {
    questionKey: "PayrollManagement.FAQs.q2",
    answerKey: "PayrollManagement.FAQs.a2",
  },
  {
    questionKey: "PayrollManagement.FAQs.q3",
    answerKey: "PayrollManagement.FAQs.a3",
  },
  {
    questionKey: "PayrollManagement.FAQs.q4",
    answerKey: "PayrollManagement.FAQs.a4",
  },
  {
    questionKey: "PayrollManagement.FAQs.q5",
    answerKey: "PayrollManagement.FAQs.a5",
  },
];

const benefits = [
  {
    titleKey: "PayrollManagement.Benefits.accuracy.title",
    descKey: "PayrollManagement.Benefits.accuracy.desc",
    icon: (
      <svg
  ...
  {
    titleKey: "PayrollManagement.Benefits.compliance.title",
    descKey: "PayrollManagement.Benefits.compliance.desc",
    icon: (
      <svg
  ...
  {
    titleKey: "PayrollManagement.Benefits.efficiency.title",
    descKey: "PayrollManagement.Benefits.efficiency.desc",
    icon: (
      <svg
        className="w-10 h-10 text-[#21c2ad]"
        fill="none"
...
const processSteps = [
  {
    titleKey: "PayrollManagement.Process.setup.title",
    descKey: "PayrollManagement.Process.setup.desc",
    noteKey: "PayrollManagement.Process.setup.note",
    icon: (
      <svg
  ...
  {
    titleKey: "PayrollManagement.Process.processing.title",
    descKey: "PayrollManagement.Process.processing.desc",
    noteKey: "PayrollManagement.Process.processing.note",
    icon: (
      <svg
  ...
  {
    titleKey: "PayrollManagement.Process.reporting.title",
    descKey: "PayrollManagement.Process.reporting.desc",
    noteKey: "PayrollManagement.Process.reporting.note",
    icon: (
      <svg
        className="w-8 h-8 text-[#21c2ad]"
        fill="none"
  ...
  {
    titleKey: "PayrollManagement.Process.compliance.title",
    descKey: "PayrollManagement.Process.compliance.desc",
    noteKey: "PayrollManagement.Process.compliance.note",
    icon: (
      <svg
        className="w-8 h-8 text-[#155dfc]"
        fill="none"
...
const PayrollManagementPage = () => {
  ...
  return (
    <>
      <Head>
        <title>{t("PayrollManagement.meta.title")}</title>
        <meta
          name="description"
          content={t("PayrollManagement.meta.description")}
        />
      </Head>
      <main className="bg-gradient-to-tr from-blue-100 via-white to-blue-200 dark:from-blue-950 dark:via-gray-900 dark:to-blue-900 min-h-screen caret-transparent">
        ...
        <section className="relative flex flex-col md:flex-row items-center justify-between px-8 py-24 gap-12 min-h-screen overflow-hidden">
          ...
          >
            <source src="payrole_management_bg_vedio.mp4" type="video/mp4" />
          ...
          <div className="relative flex-1 flex flex-col justify-center items-start z-20 text-blue-900 dark:text-blue-100">
            <h1 className="text-5xl md:text-6xl font-extrabold mb-6 leading-tight drop-shadow-lg">
              {t("PayrollManagement.Hero.title")}
            </h1>
            <p className="text-lg md:text-2xl mb-8 max-w-xl">
              {t("PayrollManagement.Hero.description")}
            </p>
          </div>
        ...
        <section className="py-20 px-8">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#155dfc] dark:text-blue-100 mb-10 text-center">
              {t("PayrollManagement.Overview.title")}
            </h2>
